...
FINA_S3_ACCESS_KEY = os.environ.get("FINA_S3_ACCESS_KEY", "fina_test")
FINA_S3_SECRET_KEY = os.environ.get("FINA_S3_SECRET_KEY", "fina_test")
FINA_S3_BUCKET_NAME = os.environ.get("FINA_S3_BUCKET_NAME", "audio-fetcher-dev")
...
def _minio_client(endpoint_url: str) -> S3Client:
    return boto3.client(  # pyright: ignore[reportUnknownMemberType]
        ...
        aws_access_key_id=FINA_S3_ACCESS_KEY,
        aws_secret_access_key=FINA_S3_SECRET_KEY,
...
def test_createbucket_created_the_dev_bucket(minio_endpoint_url: str) -> None:
    ...
    try:
        client.head_bucket(Bucket=FINA_S3_BUCKET_NAME)
    except ClientError as exc:
        pytest.fail(
            f"Bucket {FINA_S3_BUCKET_NAME!r} is not reachable at {minio_endpoint_url} "
